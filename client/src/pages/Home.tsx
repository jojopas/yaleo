        ...
        <div className="container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
            {[
              ...
              { name: "Tony Roberts", role: "Drummer", img: "/images/bios/tony-roberts.jpg", bio: "Tony Robinson began playing drums at age 5 and has toured nationally as a singer-songwriter, releasing albums DRIFTING and 02.04.21. He has opened for Robben Ford, Corey Harris, and Jarekus Singleton. Based in Central Florida since 2020, Tony also serves as editor and founder of Synth Head Magazine." },
              ...
              { name: "Tito Alonso", role: "Percussion", img: "/images/bios/tito-alonso.jpg", bio: "Tito Alonso is a dynamic Latin percussionist whose passion for rhythm began in Puerto Rico, where he transformed paint buckets, pots, pans, and wooden spoons into his first drum set. By age eleven, he had already developed an ear for rhythm, teaching himself by listening to music and studying drum parts at home. Rooted in Latin percussion and inspired by rock, Tito naturally gravitated toward the music of Santana, blending Afro-Latin rhythms with the energy and soul of classic rock. His versatility has led him to perform across multiple genres including Latin, jazz, funk, disco, house, dance, and rock. A veteran of Florida's live music and club scene, Tito became known for high-energy collaborations with DJs throughout Ybor City and Central Florida, bringing live congas and percussion to house, breakbeats, hip-hop, and electronic music long before live percussion became a mainstream trend." },
              ...
              { name: "Jon Sierra", role: "Vocalist", img: "/images/bios/jon-sierra.jpg", bio: "Jon Sierra is a vocalist, performer, and creative artist with a lifelong passion for music and storytelling. A native New Yorker of Puerto Rican heritage, he has spent decades performing across salsa, Latin rock, worship music, and musical theatre. He also spent more than a decade as a worship leader and music director, leading bands and developing musicians. Jon is an accomplished theatre performer with credits including West Side Story, Footloose, and the lead role of Conrad Birdie in Bye Bye Birdie. When he's not on stage, he works as an award-winning creative director, mural artist, and entrepreneur." },
